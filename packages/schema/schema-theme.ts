...
export const schema: DSchema = {
	...
	"d-slide": {
		...
		fields: {
			label: { displayName: "Label", type: "text" },
			heading: headingField,
			title1: { displayName: "Title 1", type: "text" },
			title2: { displayName: "Title 2", type: "text" },
			description: descriptionField,
			buttons: buttonsField,
			image: imageField,
		},
	...
	"block-hero-3": {
		name: "block-hero-3",
		displayName: "Hero Block 3",
		fields: {
			slides: {
				displayName: "Slides",
				type: "blocks",
				componentWhitelist: ["d-slide"],
			},
			speed: { displayName: "Speed", type: "number" },
		},
	},
