    ...
    <div class="mx-auto max-w-sm rounded-lg border border-neutral-50 bg-white p-8 shadow">
      ...
      <form @submit.prevent="login" class="flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-2">
          <DButton :loading type="submit" text-center>Anmelden</DButton>
          <DButton to="/register" variant="secondary" text-center>Registrieren</DButton>
          <DButton to="/forgot-password" variant="transparent" text-center>Passwort vergessen?</DButton>
        </div>
