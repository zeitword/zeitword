...
<template>
  <div class="flex">
    <header
      class="flex flex-col justify-between border-r border-neutral-200 bg-neutral-50"
      :class="collapsed ? 'w-fit' : 'w-[230px]'"
    >
      <nav class="flex flex-col gap-0.5 p-2">
        <div
          class="group flex h-9 cursor-default items-center justify-between gap-2 rounded-md text-sm text-neutral-700"
        >
          <div
            v-show="!collapsed"
